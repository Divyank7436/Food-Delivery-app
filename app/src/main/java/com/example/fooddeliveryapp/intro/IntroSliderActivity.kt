...
import com.example.fooddeliveryapp.adapters.ViewPagerAdapter
import com.example.fooddeliveryapp.auth.LoginActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nextbtn.setOnClickListener {
            if (getitem(0) < 2) {
                ...
                val i = Intent(this@IntroSliderActivity, LoginActivity::class.java)
                startActivity(i)
                finish()
            }
        }
